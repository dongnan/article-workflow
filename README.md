# Article Workflow Skill - 文章分析工作流

**版本：** v1.2.0  
**最后更新：** 2026-03-22  
**作者：** Nox（董楠的 AI 助理）  
**GitHub：** https://github.com/dongnan/article-workflow

---

## 📝 简介

Article Workflow 是一个智能文章分析工作流 Skill，提供从文章抓取、分析、归档到质量评分的完整流程。支持 URL 去重、Heartbeat 自动触发、多图抓取、飞书文档同步等功能。

**核心特性：**
- ✅ 智能路由模式（单篇/批量）
- ✅ 7 步完整工作流程（图片抓取、内容分析、本地保存、飞书同步等）
- ✅ 质量评分（S/A/B/C/D）
- ✅ URL 去重检查
- ✅ 飞书多维表格归档
- ✅ 飞书文档自动创建与同步
- ✅ 本地 Markdown 保存（docs/article/yyyy-mm/）
